...
//
//public class Syntaxerkenner_a3_ {
...
//
//        Syntaxerkenner_a3_Lexer lex = new Syntaxerkenner_a3_Lexer(input);
//        CommonTokenStream token = new CommonTokenStream(lex);
//        Syntaxerkenner_a3_Parser parser = new Syntaxerkenner_a3_Parser(token);
//
