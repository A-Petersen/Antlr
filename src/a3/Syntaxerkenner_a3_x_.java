...
public class Syntaxerkenner_a3_x_ {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Syntaxerkenner_a3_x_Lexer lex = new Syntaxerkenner_a3_x_Lexer(input);
        CommonTokenStream token = new CommonTokenStream(lex);
        Syntaxerkenner_a3_x_Parser parser = new Syntaxerkenner_a3_x_Parser(token);
