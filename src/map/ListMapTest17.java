...
//    List<Integer> ex1 = list(1,1,4,2, 2, 3,4,5,6,7);
    ...
    public void testGroupBy() throws Exception {
        ...
        assertEquals(Integer.valueOf(361), map.get("Mickey").foldRight(0, x -> y -> y + x.amount));
        assertEquals(Integer.valueOf(601), map.get("Minnie").foldRight(0, x -> y -> y + x.amount));
        assertEquals(Integer.valueOf(175), map.get("Donald").foldRight(0, x -> y -> y + x.amount));
        assertEquals(Integer.valueOf(0), map.contains("Goofy") ? map.get("Goofy").foldRight(0, x -> y -> y + x.amount) : Integer.valueOf(0));
    }
